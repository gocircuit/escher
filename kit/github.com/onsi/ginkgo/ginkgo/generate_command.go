...
import (
	...
	{{if .IncludeImports}}. "github.com/gocircuit/escher/kit/github.com/onsi/ginkgo"{{end}}
	{{if .IncludeImports}}. "github.com/gocircuit/escher/kit/github.com/onsi/gomega"{{end}}
)
