...
var _ = Describe("TestSuite", func() {
	...
	BeforeEach(func() {
		...
		writeFile("/colonelmustard", "colonelmustard_test.go", `import "github.com/gocircuit/escher/kit/github.com/onsi/ginkgo"`)

		//ginkgo tests in a deeply nested directory
		writeFile("/colonelmustard/library", "library_test.go", `import "github.com/gocircuit/escher/kit/github.com/onsi/ginkgo"`)
	})
