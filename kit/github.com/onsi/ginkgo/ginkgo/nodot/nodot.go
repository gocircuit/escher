...
func generateNodotSections() ([]nodotSection, error) {
	...
	declarations, err := getExportedDeclerationsForPackage("github.com/gocircuit/escher/kit/github.com/onsi/ginkgo", "ginkgo_dsl.go", "GINKGO_VERSION", "GINKGO_PANIC")
	if err != nil {
		return nil, err
	}
	...
	declarations, err = getExportedDeclerationsForPackage("github.com/gocircuit/escher/kit/github.com/onsi/gomega", "gomega_dsl.go", "GOMEGA_VERSION")
	if err != nil {
		return nil, err
	}
	sections = append(sections, nodotSection{
	...
	declarations, err = getExportedDeclerationsForPackage("github.com/gocircuit/escher/kit/github.com/onsi/gomega", "matchers.go")
	if err != nil {
		return nil, err
	}
	sections = append(sections, nodotSection{
